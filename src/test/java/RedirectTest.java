...
public class RedirectTest extends RedirectTestBaseTest {
    ...
    @DisplayName("Успешный переход в личный кабинет по кнопке \"" + BUTTON_TITLE_PROFILE + "\" в хедере сайта")
    ...
    @Test
    @Story(TITLE_REDIRECT)
    @DisplayName("Успешный переход из личного кабинета в конструктор по кнопке \"" +
    ...
    @Test
    @Story(TITLE_REDIRECT)
    @DisplayName("Успешный переход из личного кабинета в конструктор по клику на логотип в хедере сайта")
    ...
    @Test
    @Story(TITLE_REDIRECT)
    @DisplayName("Успешный переход из личного кабинета на страницу авторизации по кнопке \"" + BUTTON_TITLE_LOGOUT + "\"")
    ...
    @Test
    @Story(TITLE_REDIRECT)
    @DisplayName("Успешный переход в конструкторе на вкладку \"" + BUTTON_TITLE_INGREDIENT_BUN + "\"")
    ...
    @Test
    @Story(TITLE_REDIRECT)
    @DisplayName("Успешный переход в конструкторе на вкладку \"" + BUTTON_TITLE_INGREDIENT_SAUCE + "\"")
    ...
    @Test
    @Story(TITLE_REDIRECT)
    @DisplayName("Успешный переход в конструкторе на вкладку \"" + BUTTON_TITLE_INGREDIENT_FILLING + "\"")
